    ...
    public class NotifikacijaController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var notifikacija = await _context.Notifikacija
                .FirstOrDefaultAsync(m => m.NotifikacijaId == id);
        ...
        public async Task<IActionResult> Create([Bind("NotifikacijaId,Poruka,DatumSlanja")] Notifikacija notifikacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NotifikacijaId,Poruka,DatumSlanja")] Notifikacija notifikacija)
        {
            if (id != notifikacija.NotifikacijaId)
            {
                return NotFound();
            }
